...
export type MockDevice = { id: string; name: string; type: DeviceType; location: string; floor: number; room: string; baseline: TrafficMetrics; current: TrafficMetrics; thresholds: TrafficMetrics; trustScore: number; status: DeviceStatus };
